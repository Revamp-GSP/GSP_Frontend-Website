                        ...
                        <div class="tab-pane fade" id="nav-rasci-edit" role="tabpanel" aria-labelledby="nav-rasci-edit-tab" tabindex="0">
                            ...
                            <div class="form-group">
                                ...
                                <div class="radio-buttons">
                                    <input type="radio" id="rasci_dirut_responsible_{{ $project->id }}" name="dirut" value="Responsible" {{ $project->dirut == 'Responsible' ? 'checked' : '' }}>
                                    <label for="rasci_dirut_responsible_{{ $project->id }}">Responsible</label>
                                    <input type="radio" id="rasci_dirut_accountable_{{ $project->id }}" name="dirut" value="Accountable" {{ $project->dirut == 'Accountable' ? 'checked' : '' }}>
                                    <label for="rasci_dirut_accountable_{{ $project->id }}">Accountable</label>
                                    <input type="radio" id="rasci_dirut_support_{{ $project->id }}" name="dirut" value="Support" {{ $project->dirut == 'Support' ? 'checked' : '' }}>
                                    <label for="rasci_dirut_support_{{ $project->id }}">Support</label>
                                    <input type="radio" id="rasci_dirut_consulted_{{ $project->id }}" name="dirut" value="Consulted" {{ $project->dirut == 'Consulted' ? 'checked' : '' }}>
                                    <label for="rasci_dirut_consulted_{{ $project->id }}">Consulted</label>
                                    <input type="radio" id="rasci_dirut_informed_{{ $project->id }}" name="dirut" value="Informed" {{ $project->dirut == 'Informed' ? 'checked' : '' }}>
                                    <label for="rasci_dirut_informed_{{ $project->id }}">Informed</label>
                                </div>
                            </div>
...
<div class="calendar">
    <form action="{{ route('project.index') }}" method="GET">
        ...
        <div class="filters">
            ...
            <input type="date" id="start-date" name="date_range_start" value="{{ request('date_range_start') }}">   

            <label for="end-date">End Date:</label>
            <input type="date" id="end-date" name="date_range_end" value="{{ request('date_range_end') }}"> 

            <button type="submit" class="filter_cal" style="width:50px">Filter</button>
        </div>
    </form>
    <div class="searchBar">
        <form action="{{ route('project.index') }}" method="GET">
...
<div class="table-responsive">
    <table class="table">
        ...
        <tbody>
            <tr>
            @php
                $baseNumber = ($projects->count() > 0) ? 1 : 0;
            @endphp
